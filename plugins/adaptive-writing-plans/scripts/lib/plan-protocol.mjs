...
export function buildHandoff(input = {}) {
  ...
  return {
    schema_version: SCHEMA_VERSION,
    source: String(sourceInput.source ?? 'adaptive-writing-plans'),
    mode,
...
function flowReceipt(map, artifactIndex, binding) {
  ...
  return {
    workflow: bootstrap.workflow ?? 'adaptive-writing-plans',
    plugin_source: bootstrap.plugin_source ?? 'plugin://adaptive-writing-plans',
