...
async function defaultCatalog() {
  ...
  const pluginCatalog = path.resolve(currentDir, '..', '..', 'skills', 'adaptive-writing-plans', 'references', 'design-provider-catalog.json');
  try {
...
export async function selectDesignProviders(profile, registry, options = {}) {
  ...
  const builtin = {
    ...
    source: 'builtin://adaptive-writing-plans/design-driver',
