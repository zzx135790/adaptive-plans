...
description: Orchestrate implementation planning when requirements, architecture, design, dependencies, or execution state may evolve. Route work to guide, map, plan, or direct while keeping project architecture memory and a re-entrant Design Gate separate from the route.
---
